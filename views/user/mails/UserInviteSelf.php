                                                ...
                                                <tr>
                                                    <td width="auto" align="center" valign="middle" height="28"
                                                        ...
                                                        <span style="color: #555555; font-weight: 300;">
                                                            <?php echo Yii::t('UserModule.views_mails_UserInviteSelf', '¡Bienvenido a %appName%!', array('%appName%' => '<strong>' . Html::encode(Yii::$app->name) . '</strong>')); ?>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" align="center">
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 22px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:center; ">                                                         
                                                        <?php echo Yii::t('UserModule.views_mails_UserInviteSelf', '<strong>Aquí podrás</strong> compartir contenido educativo, experiencias pedagógicas y nuevas metodologías de enseñanza, además de ejercer el aprendizaje colaborativo y generar nuevas redes profesionales.'); ?><br/><br/>
                                            ...
                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="auto" align="center" valign="middle" height="32"
                                                        style=" background-color:<?= Yii::$app->view->theme->variable('primary') ?>;  border-radius:5px; background-clip: padding-box;font-size:14px; font-family:Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#ffffff; font-weight: 600; padding-left:30px; padding-right:30px; padding-top: 5px; padding-bottom: 5px;">
