                                                ...
                                                <tr>
                                                    <td width="auto"  align="center" valign="middle" height="28" style=" background-color:#ffffff; background-clip: padding-box; font-size:26px; font-family:Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#a3a2a2; font-weight: 300; padding-left:18px; padding-right:18px; ">
                                                        ...
                                                        <span style="color: #555555; font-weight: 300;">
                                                            <?php echo Yii::t('UserModule.views_mails_UserInviteSpace', 'Tienes una invitación para unirte a {space} en {name}.', ['space' => '<strong>' . Html::encode($space->name) . '</strong>', 'name' => Html::encode(Yii::$app->name)]); ?>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" align="center" >
                                                ...
                                                <tr>
                                                    <td  style="font-size: 14px; line-height: 22px; padding-left: 50px; padding-right: 50px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:center; ">                                                        
                                                        <!-- START: CONTENT -->
                                                        <?php echo Yii::t('UserModule.views_mails_UserInviteSpace', 'En {name} podrás compartir contenido educativo, experiencias pedagógicas y nuevas metodologías de enseñanza, además de ejercer el aprendizaje colaborativo y generar nuevas redes profesionales.', ['name' => '<strong>' . Html::encode(Yii::$app->name) . '</strong>']); ?><br/><br/>
