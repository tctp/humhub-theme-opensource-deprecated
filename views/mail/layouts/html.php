                                ...
                                <table width="560" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width" style="background-color: <?= $colorPrimary ?>; ">
                                    <tr>
                                        <td valign="top" height="10">
                                            <img style="margin:10px auto 0px auto" src="<?php echo Yii::$app->settings->get('baseUrl') . '/uploads/logo_image/logo.png?cacheId=0'?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td height="30" align="center" valign="top" style="font-size: 11px;  line-height: 18px; font-weight:300; text-align: center; font-family:Open Sans,Arail,Tahoma, Helvetica, Arial, sans-serif;">
                                <?php if (isset(Yii::$app->view->params['showUnsubscribe']) && Yii::$app->view->params['showUnsubscribe'] === true) : ?>
                                    ...
                                    <span style="text-decoration: none; color: #a3a2a2;">
                                        <a href="<?= $url ?>" style="text-decoration: none; color: #a3a2a2;"><?= Yii::t('base', 'Unsubscribe') ?></a>
                                    </span>
                                    <br/>
                                    <br/>
                                <?php endif; ?>
